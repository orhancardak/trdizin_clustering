...
# Embedding oluştururken kullandığımız koşulla aynı filtreyi uyguluyoruz.
...
print("Embedding satırı:", embeddings.shape[0])
...
if len(df) != embeddings.shape[0]:
    raise ValueError(
        ...
        f"Makale={len(df)}, Embedding={embeddings.shape[0]}"
    )
...
# DUPLICATE KONTROL
# ============================================================
duplicate_external_ids = index_df["external_id"].duplicated().sum()
print("Tekrarlanan external_id:", duplicate_external_ids)
...
index_df.to_csv(OUTPUT_FILE, index=False, encoding="utf-8-sig")
